...
${executive_dashboard} =  https://staging.rentlytics.com/bh-management/bi/overview-executive/visualization
...
Add Executive Collection File
    create file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt
...
Properties/Units
    ...
    log  ${kpi1_1}
    log  ${kpi1_2}
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi1_1}\n
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi1_2}\n
...
Current Occupancy/Future Occupancy %
    ...
    log  ${kpi2_1}
    log  ${kpi2_2}
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi2_1}\n
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi2_2}\n
...
Average Actual Rent/Loss to Lease
    ...
    log  ${kpi3_1}
    log  ${kpi3_2}
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi3_1}\n
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi3_2}\n
...
NOI Budget Variance%/Variance in $
    ...
    log  ${kpi4_1}
    log  ${kpi4_2}
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi4_1}\n
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi4_2}\n
...
YOY NOI/^in $
    ...
    log  ${kpi5_1}
    log  ${kpi5_2}
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi5_1}\n
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi5_2}\n
...
YOY Potential Rent/^in $
    ...
    log  ${kpi6_1}
    log  ${kpi6_2}
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi6_1}\n
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi6_2}\n
...
Expense Ratio
    ...
    log  ${kpi7_1}
    #log  ${kpi7_2}
    append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi7_1}\n
    #append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${kpi7_2}\n

#Has Data Primary
    #wait until keyword succeeds  2 min  3 sec  xpath should match x times  //div[@class='rl-primary-kpi-value']  7
    #${has_data_primary} =  get webelements  xpath=//div[@class='rl-primary-kpi-value']
    #:FOR  ${has_data_primary}  IN   @{has_data_primary}
    # \       wait until element is visible  ${has_data_primary}
    # \       ${has_data_p1}=  element should be visible  ${has_data_primary}
    # \       ${get_text1}=  get text  ${has_data_primary}
    # \       log  ${get_text1}
    # \       append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${get_text1}\n
...
#Has Data Secondary
    ...
    # \       log  ${get_text2}
    # \       append to file   HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${get_text2}\n


Executive KPI Difference
    copy file  ./HasDataProd/HasDataBH/Results/Exe_Value_File.txt  ${output_dir}/HasDataProd/HasDataBH/Results/Exe_Value_File.txt

    copy file  ./HasDataStage/HasDataBH/Results/Exe_Value_File.txt  ${output_dir}/HasDataStage/HasDataBH/Results/Exe_Value_File.txt

    diff kpis  ./HasDataProd/HasDataBH/Results/Exe_Value_File.txt  ./HasDataStage/HasDataBH/Results/Exe_Value_File.txt  Management Executive