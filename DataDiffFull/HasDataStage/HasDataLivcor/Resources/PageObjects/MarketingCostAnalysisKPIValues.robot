...
Rentlytics Livcor Cost Analysis Has Data
    ...
    Cost Analysis Has Data Diff




Navigate to Livcor Cost Analysis
    go to  https://staging.rentlytics.com/livcor/bi/marketing-cost-analysis/visualization
...
Add Marketing Cost Analysis Collection File
    create file   HasDataStage/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt

Marketing Cost Analysis Cost Per Contact
    ${MCAkpi1} =      Get Text    //div[@id="kpi1"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MCAkpi1}
    append to file   HasDataStage/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt  ${MCAkpi1}\n

Marketing Cost Analysis Cost Per Application
    ${MCAkpi2_1} =      Get Text    //div[@id="kpi2"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MCAkpi2_1}
    append to file   HasDataStage/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt  ${MCAkpi2_1}\n

Marketing Cost Analysis Cost Per App Approved
    ${MCAkpi3_1} =      Get Text    //div[@id="kpi3"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MCAkpi3_1}
    append to file   HasDataStage/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt  ${MCAkpi3_1}\n

Marketing Cost Analysis Cost Per Move-In
    ${MCAkpi4_1} =      Get Text    //div[@id="kpi4"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MCAkpi4_1}
    append to file   HasDataStage/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt  ${MCAkpi4_1}\n
...
#Cost Analysis Has Data Primary
    ...
    # \       log  ${MCA_get_text1}
    # \       append to file   HasDataStage/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt  ${MCA_get_text1}\n
...
Cost Analysis Has Data Diff
    copy file  ./HasDataProd/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt  ${output_dir}/HasDataProd/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt

    copy file  ./HasDataStage/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt  ${output_dir}/HasDataStage/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt

    diff kpis  ./HasDataProd/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt  ./HasDataStage/HasDataLivcor/Results/Cost_Analysis_KPIs_File.txt  Management Cost Analysis
