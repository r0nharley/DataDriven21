...
Rentlytics Livcor Operations Single Property Has Data
    ...
    Navigate to Livcor Operations Single Property
    Maximize OSP Window
...
Navigate to Livcor Operations Single Property
    go to  https://staging.rentlytics.com/livcor/bi/operations-single-property/visualization
...
Add Operations Single Property KPIs Collection File
    create file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt

Operations Single Property # Units
    ${OSPkpi1} =      Get Text    //div[@id="kpi1"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi1}\n

Operations Single Property Occupancy Percentage
    ${OSPkpi2_1} =      Get Text    //div[@id="kpi2"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi2_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi2_1}\n

Operations Single Property Vacant Units
    ${OSPkpi3_1} =      Get Text    //div[@id="kpi3"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi3_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi3_1}\n

Operations Single Property Notice Units
    ${OSPkpi4_1} =      Get Text    //div[@id="kpi4"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi4_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi4_1}\n

#Operations Single Property AVG Actual Rent
    #${OSPkpi5_1} =      Get Text    //div[@id="kpi5"]//div[contains(@class,'rl-primary-kpi-value')]
    #log  ${OSPkpi5_1}
    #append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi5_1}\n

Operations Single Property Vacant Market Rent
    ${OSPkpi6_1} =      Get Text    //div[@id="kpi6"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi6_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi6_1}\n

#Operations Single Property Loss To Lease
    #${OSPkpi7_1} =      Get Text    //div[@id="kpi7"]//div[contains(@class,'rl-primary-kpi-value')]
    #log  ${OSPkpi7_1}
    #append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi7_1}\n

Operations Single Property Loss To Lease %
    ${OSPkpi8_1} =      Get Text    //div[@id="kpi8"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi8_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi8_1}\n

Operations Single Property # Of Delinquent Residents
    ${OSPkpi9_1} =      Get Text    //div[@id="kpi9"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi9_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi9_1}\n

Operations Single Property AVG Outstanding Balance
    ${OSPkpi10_1} =      Get Text    //div[@id="kpi10"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi10_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi10_1}\n

Operations Single Property Delinquent % of Rent
    ${OSPkpi11_1} =      Get Text    //div[@id="kpi11"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi11_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi11_1}\n

Operations Single Property Total Aged Balance
    ${OSPkpi12_1} =      Get Text    //div[@id="kpi12"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi12_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi12_1}\n

Operations Single Property Future Occupancy %
    ${OSPkpi13_1} =      Get Text    //div[@id="kpi13"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi13_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi13_1}\n

Operations Single Property OEnding Move-Ins
    ${OSPkpi14_1} =      Get Text    //div[@id="kpi14"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi14_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi14_1}\n


Operations Single Property NTV Units
    ${OSPkpi15_1} =      Get Text    //div[@id="kpi15"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi15_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi15_1}\n

Operations Single Property Rented %
    ${OSPkpi16_1} =      Get Text    //div[@id="kpi16"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi16_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi16_1}\n

Operations Single Property Vacant Units 2
    ${OSPkpi17_1} =      Get Text    //div[@id="kpi17"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi17_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi17_1}\n

Operations Single Property Current Vacancy Cost
    ${OSPkpi18_1} =      Get Text    //div[@id="kpi18"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi18_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi18_1}\n
...
Operations Single Property AVG Days Vacant
    ...
    log  ${OSPkpi19_1}
    log  ${OSPkpi19_2}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi19_1}\n
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi19_2}\n
...
Operations Single Property Make Ready %
    ...
    log  ${OSPkpi20_1}
    log  ${OSPkpi20_2}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi20_1}\n
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi20_2}\n

Operations Single Property AVG Lease Term
    ${OSPkpi21_1} =      Get Text    //div[@id="kpi21"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi21_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi21_1}\n

Operations Single Property AVG Months of Tenancy
    ${OSPkpi22_1} =      Get Text    //div[@id="kpi22"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OSPkpi22_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSPkpi22_1}\n
...
#Operations Single Property Has Data Primary
    ...
    # \       log  ${OSP_get_text1}
    # \       append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSP_get_text1}\n
...
#Operations Single Property Has Data Secondary
    ...
    # \       log  ${OSP_get_text2}
    # \       append to file   HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${OSP_get_text2}\n


Operations Single Property Has Data Diff
    copy file  ./HasDataProd/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${output_dir}/HasDataProd/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt

    copy file  ./HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ${output_dir}/HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt

    diff kpis  ./HasDataProd/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  ./HasDataStage/HasDataLivcor/Results/Operations_Single_Property_KPIs_File.txt  Management Operations Single Property
