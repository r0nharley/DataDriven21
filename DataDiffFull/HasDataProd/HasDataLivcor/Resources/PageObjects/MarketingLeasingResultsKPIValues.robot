...
Navigate to Livcor Marketing Leasing Results
    go to  https://secure.rentlytics.com/livcor/bi/marketing-leasing-results/visualization
...
Add Marketing Leasing Results Collection File
    create file   HasDataProd/HasDataLivcor/Results/Marketing_Leasing_Results_KPIs_File.txt
...
Marketing Leasing Results Total First Contacts
    ...
    log  ${MLRkpi1}
    log  ${MLRkpi2}
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Leasing_Results_KPIs_File.txt  ${MLRkpi1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Leasing_Results_KPIs_File.txt  ${MLRkpi2}\n

Marketing Leasing Results Move-In Percentage
    ${MLRkpi2_1} =      Get Text    //div[@id="kpi2"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MLRkpi2_1}
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Leasing_Results_KPIs_File.txt  ${MLRkpi2_1}\n
...
Marketing Leasing Results Total AVG Lease Rent
    ...
    log  ${MLRkpi3_1}
    log  ${MLRkpi3_2}
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Leasing_Results_KPIs_File.txt  ${MLRkpi3_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Leasing_Results_KPIs_File.txt  ${MLRkpi3_2}\n
...
Marketing Leasing Results Last 30 Days Lease Rent
    ...
    log  ${MLRkpi4_1}
    log  ${MLRkpi4_2}
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Leasing_Results_KPIs_File.txt  ${MLRkpi4_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Leasing_Results_KPIs_File.txt  ${MLRkpi4_2}\n
...
#Marketing Leasing Results Has Data Primary
    ...
    # \       log  ${MLR_get_text1}
    # \       append to file   HasDataProd/HasDataLivcor/Results/Marketing_Leasing_Results_KPIs_File.txt  ${MLR_get_text1}\n
...
#Marketing Leasing Results Has Data Secondary
    ...
    # \       log  ${MLR_get_text2}
    # \       append to file   HasDataProd/HasDataLivcor/Results/Marketing_Leasing_Results_KPIs_File.txt  ${MLR_get_text2}\n