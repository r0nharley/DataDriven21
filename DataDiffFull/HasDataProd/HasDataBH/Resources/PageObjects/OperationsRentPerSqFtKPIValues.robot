...
Navigate to BH Management Operations Rent per Sq Ft
    go to  https://secure.rentlytics.com/bh-management/bi/operations-rent-per-sq-ft/visualization
...
Add Operations Rent per Sq Ft KPIs Collection File
    create file  HasDataProd/HasDataBH/Results/Operations_RentperSQFT_File.txt
...
Operations Rent per Sq Ft Occupied SQ FT
    ...
    log  ${RPSFkpi1}
    append to file   HasDataProd/HasDataBH/Results/Operations_RentperSQFT_File.txt  ${RPSFkpi1}\n
...
Operations Rent per Sq Ft Avg Actual Rent PSF
    ...
    log  ${RPSFkpi2_1}
    log  ${RPSFkpi2_2}
    append to file   HasDataProd/HasDataBH/Results/Operations_RentperSQFT_File.txt  ${RPSFkpi2_1}\n
    append to file   HasDataProd/HasDataBH/Results/Operations_RentperSQFT_File.txt  ${RPSFkpi2_2}\n
...
Operations Rent per Sq Ft Most Recent Rents PSF
    ...
    log  ${RPSFkpi3_1}
    log  ${RPSFkpi3_2}
    append to file   HasDataProd/HasDataBH/Results/Operations_RentperSQFT_File.txt  ${RPSFkpi3_1}\n
    append to file   HasDataProd/HasDataBH/Results/Operations_RentperSQFT_File.txt  ${RPSFkpi3_2}\n


Operations Rent per Sq Ft Occupied Market Rent PSF
    ${RPSFkpi4_1} =      Get Text    //div[@id="kpi4"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${RPSFkpi4_1}
    append to file   HasDataProd/HasDataBH/Results/Operations_RentperSQFT_File.txt  ${RPSFkpi4_1}\n
...
#Operations Rent per Sq Ft Has Data Primary
    ...
    # \       log  ${RPSF_get_text1}
    # \       append to file   HasDataProd/HasDataBH/Results/Operations_RentperSQFT_File.txt  ${RPSF_get_text1}\n
...
#Operations Rent per Sq Ft Has Data Secondary
    ...
    # \       log  ${RPSF_get_text2}
    # \       append to file   HasDataProd/HasDataBH/Results/Operations_RentperSQFT_File.txt  ${RPSF_get_text2}\n
