...
Navigate to Winterwood Finances Capex
    go to  https://secure.rentlytics.com/winterwood/bi/finances-capex/visualization
...
Add Finances Capex Collection File
    create file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt
...
Finances Capex Actual Per Unit
    ...
    log  ${FCkpi1}
    log  ${FCkpi2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi2}\n
...
Finances Capex Total Capex
    ...
    log  ${FCkpi2_1}
    log  ${FCkpi2_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi2_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi2_2}\n
...
Finances Capex Budget Variance
    ...
    log  ${FCkpi3_1}
    log  ${FCkpi3_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi3_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi3_2}\n
...
Finances Capex Capex % Of Revenue
    ...
    log  ${FCkpi4_1}
    #log  ${FCkpi4_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi4_1}\n
    #append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi4_2}\n
...
Finances Capex Total Interior Capex
    ...
    log  ${FCkpi5_1}
    log  ${FCkpi5_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi5_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi5_2}\n
...
Finances Capex Total Exterior Capex
    ...
    log  ${FCkpi6_1}
    log  ${FCkpi6_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi6_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FCkpi6_2}\n
...
#Finances Capex Has Data Primary
   ...
   #  \       log  ${FC_get_text1}
   #  \       append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FC_get_text1}\n
...
#Finances Capex Has Data Secondary
   ...
   #  \       log  ${FC_get_text2}
   #  \       append to file   HasDataProd/HasDataWinterwood/Results/Finances_Capex_KPIs_File.txt  ${FC_get_text2}\n
