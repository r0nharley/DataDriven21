...
Navigate to Winterwood Finances Utilities
    go to  https://secure.rentlytics.com/winterwood/bi/finances-utilities/visualization
...
Add Finances Utilities Collection File
    create file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt
...
Finances Net Total Utilities
    ...
    log  ${FUkpi1}
    log  ${FUkpi2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi2}\n
...
Finances Utilities % Variance
    ...
    log  ${FUkpi2_1}
    log  ${FUkpi2_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi2_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi2_2}\n
...
Finances Utilities Actual Per Unit
    ...
    log  ${FUkpi3_1}
    log  ${FUkpi3_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi3_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi3_2}\n
...
Finances Utilities Actual Recovery %
    ...
    log  ${FUkpi4_1}
    log  ${FUkpi4_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi4_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi4_2}\n
...
Finances Utilities Water Recovery %
    ...
    log  ${FUkpi5_1}
    log  ${FUkpi5_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi5_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi5_2}\n
...
Finances Utilities Electric Recovery
    ...
    log  ${FUkpi6_1}
    log  ${FUkpi6_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi6_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi6_2}\n
...
Finances Utilities Gas Recovery
    ...
    log  ${FUkpi7_1}
    log  ${FUkpi7_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi7_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi7_2}\n
...
Finances Utilities Trash Recovery
    ...
    log  ${FUkpi8_1}
    log  ${FUkpi8_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi8_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FUkpi8_2}\n
...
#Finances Utilities Has Data Primary
   ...
   #  \       log  ${FU_get_text1}
   #  \       append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FU_get_text1}\n
...
#Finances Utilities Has Data Secondary
   ...
   #  \       log  ${FU_get_text2}
   #  \       append to file   HasDataProd/HasDataWinterwood/Results/Finances_Utilities_KPIs_File.txt  ${FU_get_text2}\n
