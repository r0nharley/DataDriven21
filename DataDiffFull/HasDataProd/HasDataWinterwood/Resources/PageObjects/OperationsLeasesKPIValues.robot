...
Navigate to Winterwood Operations Leases
    go to  https://secure.rentlytics.com/winterwood/bi/operations-leases/visualization
...
Add Operations Leases KPIs Collection File
    create file  HasDataProd/HasDataWinterwood/Results/Operations_Leases_KPIs_File.txt

Operations Leases # Occupied Units
    ${OLkpi1} =      Get Text    //div[@id="kpi1"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OLkpi1}
    append to file   HasDataProd/HasDataWinterwood/Results/Operations_Leases_KPIs_File.txt  ${OLkpi1}\n

Operations Leases AVG Months of Tenacy
    ${OLkpi2_1} =      Get Text    //div[@id="kpi2"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OLkpi2_1}
    append to file   HasDataProd/HasDataWinterwood/Results/Operations_Leases_KPIs_File.txt  ${OLkpi2_1}\n

Operations Leases AVG Lease Term
    ${OLkpi3_1} =      Get Text    //div[@id="kpi3"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OLkpi3_1}
    append to file   HasDataProd/HasDataWinterwood/Results/Operations_Leases_KPIs_File.txt  ${OLkpi3_1}\n
...
#Operations Leases Has Data Primary
    ...
    # \       log  ${OL_get_text1}
    # \       append to file   HasDataProd/HasDataWinterwood/Results/Operations_Leases_KPIs_File.txt  ${OL_get_text1}\n
