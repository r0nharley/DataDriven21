...
Navigate to BH Management Operations Rents
    go to  https://staging.rentlytics.com/bh-management/bi/operations-rents/visualization
...
Add Operations Rents KPIs Collection File
    create file  HasDataStage/HasDataBH/Results/Operations_Rents_File.txt

Operations Rents # Occupied Units
    ${ORkpi1} =      Get Text    //div[@id="kpi1"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ORkpi1}
    append to file   HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${ORkpi1}\n
...
Operations Rents AVG Actual Rent
    ...
    log  ${ORkpi2_1}
    log  ${ORkpi2_2}
    append to file   HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${ORkpi2_1}\n
    append to file   HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${ORkpi2_2}\n
...
Operations Rents AVG Rent PSF
    ...
    log  ${ORkpi3_1}
    log  ${ORkpi3_2}
    append to file   HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${ORkpi3_1}\n
    append to file   HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${ORkpi3_2}\n
...
Operations Rents Most Recent Rents
    ...
    log  ${ORkpi4_1}
    log  ${ORkpi4_2}
    append to file   HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${ORkpi4_1}\n
    append to file   HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${ORkpi4_2}\n


Operations Rents Occupied Market Rent
    ${ORkpi5_1} =      Get Text    //div[@id="kpi5"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ORkpi5_1}
    append to file   HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${ORkpi5_1}\n

Operations Rents Vacant Market Rent
    ${ORkpi6_1} =      Get Text    //div[@id="kpi6"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ORkpi6_1}
    append to file   HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${ORkpi6_1}\n
...
#Operations Rents Has Data Primary
    ...
    # \       log  ${OR_get_text1}
    # \       append to file   HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${OR_get_text1}\n
...
#Operations Rents Has Data Secondary
    ...
    # \       log  ${OR_get_text2}
    # \       append to file   HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${OR_get_text2}\n


Operations Rents Has Data Difference
    copy file  ./HasDataProd/HasDataBH/Results/Operations_Rents_File.txt  ${output_dir}/HasDataProd/HasDataBH/Results/Operations_Rents_File.txt

    copy file  ./HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  ${output_dir}/HasDataStage/HasDataBH/Results/Operations_Rents_File.txt

    diff kpis  ./HasDataProd/HasDataBH/Results/Operations_Rents_File.txt  ./HasDataStage/HasDataBH/Results/Operations_Rents_File.txt  Management Operations Rents