...
Navigate to BH Management Operations Delinquency
    go to  https://secure.rentlytics.com/bh-management/bi/operations-delinquency/visualization
...
Add Operations Delinquency KPIs Collection File
    create file  HasDataProd/HasDataBH/Results/Operations_Delinquency_File.txt


Operations # Delinquent
    ${ODkpi1} =      Get Text    //div[@id="kpi1"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ODkpi1}
    append to file   HasDataProd/HasDataBH/Results/Operations_Delinquency_File.txt  ${ODkpi1}\n

Operations $ Per Delinquent Residents
    ${ODkpi2_1} =      Get Text    //div[@id="kpi2"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ODkpi2_1}
    append to file   HasDataProd/HasDataBH/Results/Operations_Delinquency_File.txt  ${ODkpi2_1}\n

Operations Total Delinquent % of Rent
    ${ODkpi3_1} =      Get Text    //div[@id="kpi3"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ODkpi3_1}
    append to file   HasDataProd/HasDataBH/Results/Operations_Delinquency_File.txt  ${ODkpi3_1}\n

Operations Total Delinquent Balance
    ${ODkpi4_1} =      Get Text    //div[@id="kpi4"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ODkpi4_1}
    append to file   HasDataProd/HasDataBH/Results/Operations_Delinquency_File.txt  ${ODkpi4_1}\n

Operations 0-30 Days Balance
    ${ODkpi5_1} =      Get Text    //div[@id="kpi5"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ODkpi5_1}
    append to file   HasDataProd/HasDataBH/Results/Operations_Delinquency_File.txt  ${ODkpi5_1}\n
...
#Operations Delinquency Has Data Primary
    ...
    #\       log  ${OD_get_text1}
    #\       append to file   HasDataProd/HasDataBH/Results/Operations_Delinquency_File.txt  ${OD_get_text1}\n
