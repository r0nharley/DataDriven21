...
Navigate to BH Management Operations Future Occupancy
    go to  https://secure.rentlytics.com/bh-management/bi/operations-future-occupancy/visualization
...
Add Operations Future Occupancy KPIs Collection File
    create file  HasDataProd/HasDataBH/Results/Operations_FutureOccupancy_File.txt
...
Operations Current Occupancy %
    ...
    log  ${OFOkpi1}
    log  ${OFOkpi2}
    append to file   HasDataProd/HasDataBH/Results/Operations_FutureOccupancy_File.txt  ${OFOkpi1}\n
    append to file   HasDataProd/HasDataBH/Results/Operations_FutureOccupancy_File.txt  ${OFOkpi2}\n
...
Operations Future Occupancy %
    ...
    log  ${OFOkpi2_1}
    log  ${OFOkpi2_2}
    append to file   HasDataProd/HasDataBH/Results/Operations_FutureOccupancy_File.txt  ${OFOkpi2_1}\n
    append to file   HasDataProd/HasDataBH/Results/Operations_FutureOccupancy_File.txt  ${OFOkpi2_2}\n
...
Operations # Vacant Units
    ...
    log  ${OFOkpi3_1}
    log  ${OFOkpi3_2}
    append to file   HasDataProd/HasDataBH/Results/Operations_FutureOccupancy_File.txt  ${OFOkpi3_1}\n
    append to file   HasDataProd/HasDataBH/Results/Operations_FutureOccupancy_File.txt  ${OFOkpi3_2}\n
...
Operations # NTV Units
    ...
    log  ${OFOkpi4_1}
    log  ${OFOkpi4_2}
    append to file   HasDataProd/HasDataBH/Results/Operations_FutureOccupancy_File.txt  ${OFOkpi4_1}\n
    append to file   HasDataProd/HasDataBH/Results/Operations_FutureOccupancy_File.txt  ${OFOkpi4_2}\n
...
#Operations Future Occupancy Has Data Primary
    ...
    # \       log  ${OFO_get_text1}
    # \       append to file   HasDataProd/HasDataBH/Results/Operations_FutureOccupancy_File.txt  ${OFO_get_text1}\n
...
#Operations Future Occupancy Has Data Secondary
    ...
    #\       log  ${OFO_get_text2}
    #\       append to file   HasDataProd/HasDataBH/Results/Operations_FutureOccupancy_File.txt  ${OFO_get_text2}\n
