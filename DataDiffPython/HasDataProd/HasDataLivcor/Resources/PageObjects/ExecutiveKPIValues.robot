...
${executive_dashboard} =  https://secure.rentlytics.com/livcor/bi/overview-executive/visualization
...
Add Executive Collection File
    create file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt
...
Properties/Units
    ...
    log  ${kpi1_1}
    log  ${kpi1_2}
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi1_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi1_2}\n
...
Current Occupancy/Future Occupancy %
    ...
    log  ${kpi2_1}
    log  ${kpi2_2}
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi2_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi2_2}\n
...
Average Actual Rent/Loss to Lease
    ...
    log  ${kpi3_1}
    log  ${kpi3_2}
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi3_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi3_2}\n
...
NOI Budget Variance%/Variance in $
    ...
    log  ${kpi4_1}
    log  ${kpi4_2}
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi4_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi4_2}\n
...
YOY NOI/^in $
    ...
    log  ${kpi5_1}
    log  ${kpi5_2}
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi5_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi5_2}\n
...
YOY Potential Rent/^in $
    ...
    log  ${kpi6_1}
    log  ${kpi6_2}
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi6_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi6_2}\n
...
Expense Ratio
    ...
    log  ${kpi7_1}
    #log  ${kpi7_2}
    append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi7_1}\n
    #append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${kpi7_2}\n
...
#Has Data Primary
   ...
   #  \       log  ${get_text1}
    # \       append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${get_text1}\n
...
#Has Data Secondary
    ...
    # \       log  ${get_text2}
    # \       append to file   HasDataProd/HasDataLivcor/Results/Executive_KPIs_File.txt  ${get_text2}\n
