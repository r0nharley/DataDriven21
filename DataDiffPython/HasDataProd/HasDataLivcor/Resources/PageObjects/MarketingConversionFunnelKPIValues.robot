...
Navigate to Livcor Marketing Conversion Funnel
    go to  https://secure.rentlytics.com/livcor/bi/marketing-conversion-funnel/visualization
...
Add Marketing Conversion Funnel Collection File
    create file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt
...
Marketing Conversion Funnel Total First Contacts
    ...
    log  ${MCFkpi1}
    log  ${MCFkpi2}
    append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCFkpi1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCFkpi2}\n
...
Marketing Conversion Funnel Total Apps Submitted
    ...
    log  ${MCFkpi2_1}
    log  ${MCFkpi2_2}
    append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCFkpi2_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCFkpi2_2}\n
...
Marketing Conversion Funnel Total Apps Denied
    ...
    log  ${MCFkpi3_1}
    log  ${MCFkpi3_2}
    append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCFkpi3_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCFkpi3_2}\n
...
Marketing Conversion Funnel Total Apps Cancelled
    ...
    log  ${MCFkpi4_1}
    log  ${MCFkpi4_2}
    append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCFkpi4_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCFkpi4_2}\n
...
Marketing Conversion Funnel Avg Days to Apply
    ...
    log  ${MCFkpi5_1}
    log  ${MCFkpi5_2}
    append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCFkpi5_1}\n
    append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCFkpi5_2}\n
...
#Marketing Conversion Funnel Has Data Primary
    ...
    # \       log  ${MCF_get_text1}
    # \       append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCF_get_text1}\n
...
#Marketing Conversion Funnel Has Data Secondary
    ...
    # \       log  ${MCF_get_text2}
    # \       append to file   HasDataProd/HasDataLivcor/Results/Conversion_Funnel_KPIs_File.txt  ${MCF_get_text2}\n
