...
Navigate to Livcor Marketing Traffic Counts
    go to  https://secure.rentlytics.com/livcor/bi/marketing-traffic-counts/visualization
...
Add Marketing Traffic Counts KPIs Collection File
    create file   HasDataProd/HasDataLivcor/Results/Marketing_Traffic_Counts_KPIs_File.txt

Marketing Traffic Counts First Contacts
    ${MTCkpi1} =      Get Text    //div[@id="kpi1"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MTCkpi1}
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Traffic_Counts_KPIs_File.txt  ${MTCkpi1}\n

Marketing Traffic Counts Shows
    ${MTCkpi2_1} =      Get Text    //div[@id="kpi2"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MTCkpi2_1}
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Traffic_Counts_KPIs_File.txt  ${MTCkpi2_1}\n

Marketing Traffic Counts Apps Submitted
    ${MTCkpi3_1} =      Get Text    //div[@id="kpi3"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MTCkpi3_1}
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Traffic_Counts_KPIs_File.txt  ${MTCkpi3_1}\n

Marketing Traffic Counts Apps Approved
    ${MTCkpi4_1} =      Get Text    //div[@id="kpi4"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MTCkpi4_1}
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Traffic_Counts_KPIs_File.txt  ${MTCkpi4_1}\n

Marketing Traffic Counts Move-Ins
    ${MTCkpi5_1} =      Get Text    //div[@id="kpi5"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MTCkpi5_1}
    append to file   HasDataProd/HasDataLivcor/Results/Marketing_Traffic_Counts_KPIs_File.txt  ${MTCkpi5_1}\n
...
#Marketing Traffic Counts Has Data Primary
    ...
    #:FOR  ${MTC_has_data_primary}  IN   @{MTC_has_data_primary}
     ...
     #\       log  ${MTC_get_text1}
     #\       append to file   HasDataProd/HasDataLivcor/Results/Marketing_Traffic_Counts_KPIs_File.txt  ${MTC_get_text1}\n
