...
Navigate to BH Management Property Groupings
    go to  https://staging.rentlytics.com/bh-management/bi/overview-property-groupings/visualization
...
Add Property Grouping KPIs Collection File
    create file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt
...
Property Grouping Properties/Units
    ...
    log  ${PGkpi1_1}
    log  ${PGkpi1_2}
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi1_1}\n
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi1_2}\n
...
Property Grouping Current Occupancy/Future Occupancy %
    ...
    log  ${PGkpi2_1}
    log  ${PGkpi2_2}
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi2_1}\n
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi2_2}\n
...
Property Grouping Average Actual Rent/Loss to Lease
    ...
    log  ${PGkpi3_1}
    log  ${PGkpi3_2}
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi3_1}\n
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi3_2}\n
...
Property Grouping NOI Budget Variance%/Variance in $
    ...
    log  ${PGkpi4_1}
    log  ${PGkpi4_2}
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi4_1}\n
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi4_2}\n
...
Property Grouping YOY NOI/^in $
    ...
    log  ${PGkpi5_1}
    log  ${PGkpi5_2}
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi5_1}\n
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi5_2}\n
...
Property Grouping YOY Potential Rent/^in $
    ...
    log  ${PGkpi6_1}
    log  ${PGkpi6_2}
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi6_1}\n
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi6_2}\n
...
Property Grouping Expense Ratio
    ...
    log  ${PGkpi7_1}
    #log  ${PGkpi7_2}
    append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi7_1}\n
    #append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PGkpi7_2}\n
...
#Property Grouping Has Data Primary
    ...
    # \       log  ${PG_get_text1}
    # \       append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PG_get_text1}\n
...
#Property Grouping Has Data Secondary
    ...
    # \       log  ${PG_get_text2}
    # \       append to file   HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${PG_get_text2}\n


Property Grouping Has Data Difference
    copy file  ./HasDataProd/HasDataBH/Results/Property_Grouping_File.txt  ${output_dir}/HasDataProd/HasDataBH/Results/Property_Grouping_File.txt

    copy file  ./HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  ${output_dir}/HasDataStage/HasDataBH/Results/Property_Grouping_File.txt

    diff kpis  ./HasDataProd/HasDataBH/Results/Property_Grouping_File.txt  ./HasDataStage/HasDataBH/Results/Property_Grouping_File.txt  Management Property Grouping