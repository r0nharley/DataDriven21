...
Rentlytics Livcor Marketing Overview Has Data
    ...
    Marketing Overview Has Data Diff




Navigate to Livcor Marketing Overview
    go to  https://staging.rentlytics.com/livcor/bi/marketing-overview/visualization
...
Add Marketing Overview KPIs Collection File
    create file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt
...
Marketing Overview Total First Contacts
    ...
    log  ${MOkpi1}
    log  ${MOkpi2}
    append to file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${MOkpi1}\n
    append to file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${MOkpi2}\n
...
Marketing Overview Total Apps Submitted
    ...
    log  ${MOkpi2_1}
    log  ${MOkpi2_2}
    append to file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${MOkpi2_1}\n
    append to file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${MOkpi2_2}\n
...
Marketing Overview Total Move-ins
    ...
    log  ${MOkpi3_1}
    log  ${MOkpi3_2}
    append to file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${MOkpi3_1}\n
    append to file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${MOkpi3_2}\n

Marketing Overview Conversion Percentage
    ${MOkpi4_1} =      Get Text    //div[@id="kpi4"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MOkpi4_1}
    append to file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${MOkpi4_1}\n

Marketing Overview Move-In Percentage
    ${MOkpi5_1} =      Get Text    //div[@id="kpi5"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MOkpi5_1}
    append to file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${MOkpi5_1}\n

Marketing Overview Cancel/Denial Ratio
    ${MOkpi6_1} =      Get Text    //div[@id="kpi6"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${MOkpi6_1}
    append to file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${MOkpi6_1}\n
...
#Marketing Overview Has Data Primary
    ...
    # \       log  ${MO_get_text1}
    # \       append to file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${MO_get_text1}\n
...
#Marketing Overview Has Data Secondary
   ...
   #  \       log  ${MO_get_text2}
   #  \       append to file   HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${MO_get_text2}\n


Marketing Overview Has Data Diff
    copy file  ./HasDataProd/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${output_dir}/HasDataProd/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt

    copy file  ./HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ${output_dir}/HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt

    diff kpis  ./HasDataProd/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  ./HasDataStage/HasDataLivcor/Results/Marketing_Overview_KPIs_File.txt  Management Marketing Overview
