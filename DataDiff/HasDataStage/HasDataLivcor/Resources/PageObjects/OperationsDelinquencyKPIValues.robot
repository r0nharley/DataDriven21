...
Rentlytics Livcor Operations Delinquency Has Data
    ...
    Navigate Livcor Operations Delinquency
    Maximize MOD Window
...
Navigate Livcor Operations Delinquency
    go to  https://staging.rentlytics.com/livcor/bi/operations-delinquency/visualization
...
Add Operations Delinquency KPIs Collection File
    create file  HasDataStage/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt


Operations # Delinquent
    ${ODkpi1} =      Get Text    //div[@id="kpi1"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ODkpi1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt  ${ODkpi1}\n

Operations $ Per Delinquent Residents
    ${ODkpi2_1} =      Get Text    //div[@id="kpi2"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ODkpi2_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt  ${ODkpi2_1}\n

Operations Total Delinquent % of Rent
    ${ODkpi3_1} =      Get Text    //div[@id="kpi3"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ODkpi3_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt  ${ODkpi3_1}\n

Operations Total Delinquent Balance
    ${ODkpi4_1} =      Get Text    //div[@id="kpi4"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ODkpi4_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt  ${ODkpi4_1}\n

Operations 0-30 Days Balance
    ${ODkpi5_1} =      Get Text    //div[@id="kpi5"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${ODkpi5_1}
    append to file   HasDataStage/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt  ${ODkpi5_1}\n
...
#Operations Delinquency Has Data Primary
    ...
    #\       log  ${OD_get_text1}
    #\       append to file   HasDataStage/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt  ${OD_get_text1}\n
...
Operations Delinquency Has Data Diff
    copy file  ./HasDataProd/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt  ${output_dir}/HasDataProd/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt

    copy file  ./HasDataStage/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt  ${output_dir}/HasDataStage/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt

    diff kpis  ./HasDataProd/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt  ./HasDataStage/HasDataLivcor/Results/Operations_Delinquency_KPIs_File.txt  Management Operations Delinquency
