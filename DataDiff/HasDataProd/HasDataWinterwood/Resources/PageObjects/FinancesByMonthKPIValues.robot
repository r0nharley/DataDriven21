...
Navigate to Winterwood Finances By Month
    go to  https://secure.rentlytics.com/winterwood/bi/finances-by-month/visualization
...
Add Finances My Month Collection File
    create file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt
...
Finances by Month Actual Per Unit/Budget
    ...
    log  ${FBMkpi1}
    log  ${FBMkpi2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi2}\n
...
Finances by Month Total Revenue %Variance
    ...
    log  ${FBMkpi2_1}
    #log  ${FBMkpi2_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi2_1}\n
    #append to file   HasDataProd/HasDataLivcor/Results/Finances_By_Month_File.txt  ${FBMkpi2_2}\n
...
Finances by Month Total Revenue Budget Variance
    ...
    log  ${FBMkpi3_1}
    #log  ${FBMkpi3_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi3_1}\n
    #append to file   HasDataProd/HasDataLivcor/Results/Finances_By_Month_File.txt  ${FBMkpi3_2}\n
...
Finances by Month Total Expenses Actual Per Unit/Budget
    ...
    log  ${FBMkpi4_1
    log  ${FBMkpi4_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi4_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi4_2}\n
...
Finances by Month Total Expenses %Variance
    ...
    log  ${FBMkpi5_1}
    #log  ${FBMkpi5_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi5_1}\n
    #append to file   HasDataProd/HasDataLivcor/Results/Finances_By_Month_File.txt  ${FBMkpi5_2}\n
...
Finances by Month Total Expenses Budget Variance
    ...
    log  ${FBMkpi6_1}
    #log  ${FBMkpi6_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi6_1}\n
    #append to file   HasDataProd/HasDataLivcor/Results/Finances_By_Month_File.txt  ${FBMkpi6_2}\n
...
Finances by Month Net Operating Income Actual Per Unit/Budget
    ...
    log  ${FBMkpi7_1}
    log  ${FBMkpi7_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi7_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi7_2}\n
...
Finances by Month Net income Acutal PEr Unit/Budget
    ...
    log  ${FBMkpi8_1}
    log  ${FBMkpi8_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi8_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi8_2}\n
...
Finances by Month Net Income %Variance
    ...
    log  ${FBMkpi9_1}
    log  ${FBMkpi9_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi9_1}\n
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi9_2}\n
...
Finances by Month Net Income Budget Variance
    ...
    log  ${FBMkpi10_1}
    #log  ${FBMkpi10_2}
    append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBMkpi10_1}\n
    #append to file   HasDataProd/HasDataLivcor/Results/Finances_By_Month_File.txt  ${FBMkpi10_2}\n
...
#Finances by Month Has Data Primary
    ...
    #:FOR  ${FMB_has_data_primary}  IN   @{FMB_has_data_primary}
     ...
     #\       log  ${FMB_get_text1}
     #\       append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FMB_get_text1}\n
...
#Finances by Month Has Data Secondary
    ...
    #:FOR  ${FBM_has_data_secondary}  IN   @{FBM_has_data_secondary}
     ...
     #\       log  ${FBM_get_text2}
     #\       append to file   HasDataProd/HasDataWinterwood/Results/Finances_by_Month_KPIs_File.txt  ${FBM_get_text2}\n