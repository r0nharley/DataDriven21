...
Navigate to Livcor Operations Occupancy
    go to  https://secure.rentlytics.com/livcor/bi/operations-occupancy/visualization
...
Add Operations Occupancy KPIs Collection File
    create file  HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt


Operations Occupancy # Units
    ${OOkpi1} =      Get Text    //div[@id="kpi1"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OOkpi1}
    append to file   HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt  ${OOkpi1}\n

Operations Occupancy Vacant Units
    ${OOkpi2_1} =      Get Text    //div[@id="kpi2"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OOkpi2_1}
    append to file   HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt  ${OOkpi2_1}\n

Operations Occupancy Make Ready %
    ${OOkpi3_1} =      Get Text    //div[@id="kpi3"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OOkpi3_1}
    append to file   HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt  ${OOkpi3_1}\n

Operations Occupancy Pending Move-Ins
    ${OOkpi4_1} =      Get Text    //div[@id="kpi4"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OOkpi4_1}
    append to file   HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt  ${OOkpi4_1}\n

Operations Occupancy Notice Units
    ${OOkpi5_1} =      Get Text    //div[@id="kpi5"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OOkpi5_1}
    append to file   HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt  ${OOkpi5_1}\n

Operations Occupancy Occupancy Percent
    ${OOkpi6_1} =      Get Text    //div[@id="kpi6"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OOkpi6_1}
    append to file   HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt  ${OOkpi6_1}\n

Operations Occupancy Future Occupancy %
    ${OOkpi7_1} =      Get Text    //div[@id="kpi7"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OOkpi7_1}
    append to file   HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt  ${OOkpi7_1}\n

Operations Occupancy AVG Days Vacant
    ${OOkpi8_1} =      Get Text    //div[@id="kpi8"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OOkpi8_1}
    append to file   HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt  ${OOkpi8_1}\n

Operations Occupancy Max Days Vacant
    ${OOkpi9_1} =      Get Text    //div[@id="kpi9"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OOkpi9_1}
    append to file   HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt  ${OOkpi9_1}\n

Operations Occupancy Vacancy Cost
    ${OOkpi10_1} =      Get Text    //div[@id="kpi10"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${OOkpi10_1}
    append to file   HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt  ${OOkpi10_1}\n
...
#Operations Occupancy Has Data Primary
    ...
    # \       log  ${OO_get_text1}
    # \       append to file   HasDataProd/HasDataLivcor/Results/Operations_Occupancy_KPIs_File.txt  ${OO_get_text1}\n
