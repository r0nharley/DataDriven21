...
${Asset_Manager_Custom_Dash} =  https://secure.rentlytics.com/bh-management/bi/bh-custom-asset-manager-custom/visualization
...
Add Custom Asset Manager Collection File
    create file   HasDataProd/HasDataBH/Results/Custom_Asset_Manager_Custom.txt

Number of Units
    ${AMC_kpi1} =      Get Text    //div[@id="kpi1"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${AMC_kpi1}
    append to file   HasDataProd/HasDataBH/Results/Custom_Asset_Manager_Custom.txt  ${AMC_kpi1}\n

Current Occupancy
    ${AMC_kpi2} =      Get Text    //div[@id="kpi2"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${AMC_kpi2}
    append to file   HasDataProd/HasDataBH/Results/Custom_Asset_Manager_Custom.txt  ${AMC_kpi2}\n

Current Effective Rent
    ${AMC_kpi3} =      Get Text    //div[@id="kpi3"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${AMC_kpi3}
    append to file   HasDataProd/HasDataBH/Results/Custom_Asset_Manager_Custom.txt  ${AMC_kpi3}\n

Vacant Units
    ${AMC_kpi4} =      Get Text    //div[@id="kpi4"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${AMC_kpi4}
    append to file   HasDataProd/HasDataBH/Results/Custom_Asset_Manager_Custom.txt  ${AMC_kpi4}\n

Future Occupancy Percentage
    ${AMC_kpi5} =      Get Text    //div[@id="kpi5"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${AMC_kpi5}
    append to file   HasDataProd/HasDataBH/Results/Custom_Asset_Manager_Custom.txt  ${AMC_kpi5}\n

T13 AVG Occupancy
    ${AMC_kpi6} =      Get Text    //div[@id="kpi6"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${AMC_kpi6}
    append to file   HasDataProd/HasDataBH/Results/Custom_Asset_Manager_Custom.txt  ${AMC_kpi6}\n

T13 Effective Rent
    ${AMC_kpi7} =      Get Text    //div[@id="kpi7"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${AMC_kpi7}
    append to file   HasDataProd/HasDataBH/Results/Custom_Asset_Manager_Custom.txt  ${AMC_kpi7}\n

Make Ready %
    ${AMC_kpi8} =      Get Text    //div[@id="kpi8"]//div[contains(@class,'rl-primary-kpi-value')]
    log  ${AMC_kpi8}
    append to file   HasDataProd/HasDataBH/Results/Custom_Asset_Manager_Custom.txt  ${AMC_kpi8}\n